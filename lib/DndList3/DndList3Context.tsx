...
interface ProviderProps extends PropsWithChildren {
    treeDepth1: { data: DraggableParent[], renderItem: (parent: DraggableParent) => JSX.Element },
    treeDepth2: { data: DraggableItem[], renderItem: (parent: DraggableItem) => JSX.Element }
}
